...
**This is exploratory work, not a result.** The internship produced a state of
the art, a model and a working agent; it did not settle the question, and the
report is a study rather than a finding.
